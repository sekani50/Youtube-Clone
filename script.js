// JavaScript source code
        ...
        class Videos {
            ...
            showVideos(vid_data) {
                ...
                document.querySelector('.videos').innerHTML += ` <div class="video-container cursor-pointer w-[222px] max-[710px]:w-[270px] max-[600px]:w-[380px] max-[650px]:w-[260px] max-[1230px]:w-[300px] max-[1075px]:w-[280px] max-[1000px]:w-[365px] max-[830px]:w-[320px] max-[800px]:w-[300px] max-[907px]:w-[330px] max-[930px]:w-[340px] max-xl:w-[300px] max-lg:w-[270px] max-[450px]:w-[100%]">
                            <div class="image-box relative w-full ">
                                <img class="main-image h-[140px]  max-[1230px]:h-[170px] max-[450px]:h-[200px] max-[450px]:rounded-[0px] w-full max-md:h-[170px] max-[1000px]:h-[215px] max-lg:h-[170px] max-[600px]:h-[230px] max-xl:h-[210px] rounded-[20px] object-cover object-center" src="${vid_data.snippet.thumbnails.high.url}" />
                ...
                */
                ...
                if (leftIcons.style.display !== "none") {
                    ...
                    Array.prototype.forEach.call(vidCont, (el) => {
                        ...
                        //console.log("inside the class");
                        el.removeAttribute("style", "height:200px");
        ...
        function displayHoverEffect() {
            ...
            Array.prototype.forEach.call(imgBoxes, (elem, index) => {
                ...
                elem.addEventListener('mouseenter', () => {
                    ...
                    //once it is 1 it should be 1 unless i am moving to another one
