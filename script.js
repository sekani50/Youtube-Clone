    ...
    showVideos(vid_data) {
        ...
        document.querySelector('.videos').innerHTML += ` <div class="video-container cursor-pointer max-[450px]:w-[100%]">
                            <div class="image-box relative">
                                <img class="h-[170px] max-[450px]:w-[100%] max-[450px]:rounded-none max-[450px]:h-[200px]  max-[1000px]:w-[385px] max-md:h-[170px] max-[1000px]:h-[215px] max-lg:h-[180px]  max-xl:h-[210px] max-xl:[287px] w-[300px] rounded-[20px] object-cover object-center" src="${vid_data.snippet.thumbnails.high.url}" />
